/* Kaitlyn Forsberg
 * This program allows the user to view different types of products.
 * These products include: books. movies, and albums.
 * This program demonstrates using polymorphism to change the virtual
...
const Book p2("The Big Short", 15.95, 34, "Michael Lewis", "Hardcopy");
